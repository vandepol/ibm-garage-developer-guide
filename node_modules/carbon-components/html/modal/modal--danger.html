...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-wcvajtzzvm">Show
  modal</button>

<div data-modal id="modal-wcvajtzzvm" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-wcvajtzzvm-label" aria-describedby="modal-wcvajtzzvm-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wcvajtzzvm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wcvajtzzvm-heading">Modal heading</p>
