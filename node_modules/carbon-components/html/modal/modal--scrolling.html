...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-d49mfm2en5">Show
  modal</button>

<div data-modal id="modal-d49mfm2en5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-d49mfm2en5-label" aria-describedby="modal-d49mfm2en5-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-d49mfm2en5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-d49mfm2en5-heading">Modal heading</p>
