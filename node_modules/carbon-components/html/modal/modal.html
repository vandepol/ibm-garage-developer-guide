...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nldza294o38">Show
  modal</button>

<div data-modal id="modal-nldza294o38" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nldza294o38-label" aria-describedby="modal-nldza294o38-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nldza294o38-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nldza294o38-heading">Modal heading</p>
