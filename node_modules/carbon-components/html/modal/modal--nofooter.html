...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-waxixj51wyn">Show
  modal</button>

<div data-modal id="modal-waxixj51wyn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-waxixj51wyn-label" aria-describedby="modal-waxixj51wyn-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-waxixj51wyn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-waxixj51wyn-heading">Modal heading</p>
