...
function (_Component) {
  ...
  _createClass(FileUploaderButton, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--btn"), "".concat(prefix, "--btn--sm"), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--btn--").concat(buttonKind), buttonKind), _defineProperty(_classNames, "".concat(prefix, "--btn--disabled"), disabled), _classNames));
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("label", _extends({
        ...
        role: role
      }, this.state.labelText)), _react.default.createElement("input", {
...
function Filename(_ref2) {
  ...
  switch (status) {
    ...
    case 'edit':
      return _react.default.createElement(_react.default.Fragment, null, invalid && _react.default.createElement(_iconsReact.WarningFilled16, {
        className: "".concat(prefix, "--file-invalid")
      }), _react.default.createElement(_iconsReact.Close16, _extends({
        className: "".concat(prefix, "--file-close"),
        "aria-label": iconDescription
      }, other), iconDescription && _react.default.createElement("title", null, iconDescription)));

    case 'complete':
      return _react.default.createElement(_iconsReact.CheckmarkFilled16, _extends({
